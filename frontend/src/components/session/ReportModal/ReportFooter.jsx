...
export function ReportFooter({
  ...
  return (
    <div className="flex items-center justify-between px-5 py-3.5 border-t border-slate-800 bg-[#1c1e22] gap-3">
      {viewMode === "PDF" ? (
        <>
          <button
            type="button"
            onClick={() => setViewMode("TEXT")}
            className="px-3.5 py-2 rounded-xl bg-[#25282e] hover:bg-[#2e323a] text-slate-200 font-semibold text-xs transition-all border border-slate-700/60 flex items-center gap-1.5"
          >
            ← Back to Text Mode
          </button>
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs transition-all flex items-center gap-1.5 shadow"
          >
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-xs font-semibold transition-all flex items-center gap-1.5 shadow ${
              isEditing
                ...
                : "bg-[#25282e] hover:bg-[#2e323a] text-slate-200 border border-slate-700/60"
            }`}
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <div ref={shareDropdownRef} className="relative">
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-[#25282e] hover:bg-[#2e323a] text-slate-200 font-semibold text-xs transition-all border border-slate-700/60 flex items-center gap-1.5 shadow"
              >
