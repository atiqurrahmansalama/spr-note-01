export function DiscardAlertModal({ showDiscardAlert, setShowDiscardAlert, handleConfirmDiscard }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-[#212327] border border-slate-700/90 rounded-2xl max-w-sm w-full p-5 shadow-2xl space-y-4 text-center">
        ...
        <div className="flex items-center gap-3 pt-2">
          <button
            ...
            className="flex-1 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold border border-slate-700/60 transition-colors"
          >
            Keep Editing
          </button>
          <button
            ...
            className="flex-1 px-3 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow transition-colors"
          >
            Discard & Close
          </button>
        </div>
