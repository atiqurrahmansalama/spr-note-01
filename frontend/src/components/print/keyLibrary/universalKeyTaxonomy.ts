...
export const UNIVERSAL_KEY_TAXONOMY: KeyTaxonomyItem[] = [
  ...
  { key: 'student_name_bn', label: 'Student Name (Bengali)', category: 'student', example: 'আব্দুল্লাহ আল মামুন', description: 'Student name in Bengali script' },
  ...
  { key: 'gpa', label: 'GPA Score', category: 'exam', example: '5.00', description: 'Grade Point Average' },
  { key: 'merit_position', label: 'Merit / Class Rank', category: 'exam', example: '1st (First Position)', description: 'Class merit standing' },
  ...
  { key: 'institution_name_bn', label: 'Institution Name (Bengali)', category: 'institution', example: 'মাদরাসা ও ইসলামিক একাডেমি', description: 'Institution name in Bengali' },
