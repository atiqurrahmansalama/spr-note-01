  ...
  const [formData, setFormData] = useState(() => {
    if (event) {
      ...
      return {
        ...
        timezone: event.timezone || (calendarSettings.getTimezone ? calendarSettings.getTimezone() : "UTC"),
    ...
    return {
      ...
      startTime: "09:00",
      endTime: "12:30",
      timezone: calendarSettings.getTimezone ? calendarSettings.getTimezone() : "UTC",
