          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto space-y-2.5 max-h-80 sm:max-h-96 pr-1 custom-scrollbar">
              {kinds.map((k) => {
                ...
                if (isEditing) {
                  return (
                    <div key={k.value} className="p-3 rounded-2xl border theme-border theme-bg-sub space-y-2 animate-fade-in">
                      <div className="flex items-center gap-2">
                        <div className="flex-1">
                          <CustomInput
                            size="sm"
                            value={editLabel}
                            onChange={(val) => setEditLabel(val)}
                        ...
                        <button
                          ...
                          className="px-3.5 py-2 rounded-xl theme-bg-accent theme-accent-text text-xs font-bold cursor-pointer hover:opacity-90 transition"
                        >
                          Save
                        </button>
                        <button
                          ...
                          className="px-3 py-2 rounded-xl border theme-border text-xs font-semibold theme-text-secondary cursor-pointer hover:theme-bg-surface transition"
                        >
                          Cancel
                        </button>
                      </div>
            ...
            <form onSubmit={handleAddKind} className="pt-3 border-t theme-border space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl theme-bg-accent theme-accent-text text-xs font-bold transition flex items-center gap-1.5 cursor-pointer disabled:opacity-40 shadow-xs hover:opacity-90 shrink-0"
                >
