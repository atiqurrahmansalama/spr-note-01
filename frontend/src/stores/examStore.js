...
export const DEFAULT_EXAM_SESSIONS = [
  {
    ...
    departmentSchedules: [
      ...
      },
      {
        ...
        departmentName: 'Kitab / Dars-e-Nizami Dept',
        departmentCode: 'KITAB',
...
export const DEFAULT_EXAM_SUBJECTS = [
  ...
  },
  {
    ...
    invigilatorId: 'teacher_1',
    invigilatorName: 'Hafiz Qari Zubair',
    examinerId: 'teacher_1',
    examinerName: 'Hafiz Qari Zubair',
    evaluatorId: 'teacher_1',
    evaluatorName: 'Hafiz Qari Zubair',
    teacherId: 'teacher_1',
    teacherName: 'Hafiz Qari Zubair',
    roomNo: 'Central Hall A',
    notes: 'Verify student attendance and oral marksheets',
    examDate: '2026-10-10',
    shiftId: 'shift_1',
    shiftName: 'Shift 1 (Morning)',
    startTime: '09:00 AM',
  ...
  },
  {
    ...
    invigilatorId: 'teacher_2',
    invigilatorName: 'Qari Abdullah',
    examinerId: 'teacher_2',
    examinerName: 'Qari Abdullah',
    evaluatorId: 'teacher_2',
    evaluatorName: 'Qari Abdullah',
    teacherId: 'teacher_2',
    teacherName: 'Qari Abdullah',
    roomNo: 'Central Hall A',
    notes: 'Check tajweed recitation voice clarity',
    examDate: '2026-10-10',
    shiftId: 'shift_2',
  ...
  },
  {
    ...
    invigilatorId: 'teacher_3',
    invigilatorName: 'Maulana Mahmudul Hasan',
    examinerId: 'teacher_3',
    examinerName: 'Maulana Mahmudul Hasan',
    evaluatorId: 'teacher_3',
    evaluatorName: 'Maulana Mahmudul Hasan',
    teacherId: 'teacher_3',
    teacherName: 'Maulana Mahmudul Hasan',
    roomNo: 'Hall 204',
    notes: 'Distribute Arabic script sheets',
    examDate: '2026-10-11',
    shiftId: 'shift_1',
    shiftName: 'Shift 1 (Morning)',
    startTime: '09:00 AM',
  ...
  },
  {
    ...
    teacherName: 'Maulana Mahmudul Hasan',
    roomNo: 'Hall 204',
    notes: 'Check student admit cards',
    examDate: '2026-10-11',
    shiftId: 'shift_2',
    shiftName: 'Shift 2 (Afternoon)',
    startTime: '02:00 PM',
  ...
  },
  {
    ...
    departmentName: 'Kitab Department',
    classId: 'cls_3',
    className: 'Nahw Class (Level 2)',
    sectionId: 'ALL',
    sectionName: 'All Sections',
    subjectName: 'Hidayatun Nahw (Arabic Syntax)',
    curriculumBookId: 'syllabus_kitab_3',
    curriculumBookName: 'Hidayatun Nahw',
    invigilatorId: 'teacher_1',
    invigilatorName: 'Hafiz Qari Zubair',
    examinerId: 'teacher_3',
    examinerName: 'Maulana Mahmudul Hasan',
    ...
    teacherName: 'Hafiz Qari Zubair',
    roomNo: 'Central Hall A',
    notes: 'Standard exam rules apply',
    examDate: '2026-10-12',
    shiftId: 'shift_1',
    shiftName: 'Shift 1 (Morning)',
    startTime: '09:00 AM',
    ...
    components: [
      { id: 'comp_1', name: 'Written Exam', maxMarks: 80 },
      { id: 'comp_2', name: 'Viva Voce', maxMarks: 20 },
    ],
    createdAt: '2026-09-01T00:00:00.000Z',
    updatedAt: '2026-09-01T00:00:00.000Z',
  },
  {
    ...
    departmentName: 'Kitab Department',
    classId: 'cls_4',
    className: 'Kafiya Class (Level 3)',
    sectionId: 'ALL',
    sectionName: 'All Sections',
    subjectName: 'Al-Kafiya fi an-Nahw',
    curriculumBookId: 'syllabus_kitab_4',
    curriculumBookName: 'Al-Kafiya',
    invigilatorId: 'teacher_2',
    invigilatorName: 'Qari Abdullah',
    examinerId: 'teacher_2',
    examinerName: 'Qari Abdullah',
    ...
    teacherName: 'Qari Abdullah',
    roomNo: 'Hall 205',
    notes: 'Verify registration numbers',
    examDate: '2026-10-14',
    shiftId: 'shift_1',
    shiftName: 'Shift 1 (Morning)',
    startTime: '09:00 AM',
    ...
    components: [
      { id: 'comp_1', name: 'Written Exam', maxMarks: 70 },
      { id: 'comp_2', name: 'Oral Exam', maxMarks: 30 },
    ],
    createdAt: '2026-09-01T00:00:00.000Z',
    updatedAt: '2026-09-01T00:00:00.000Z',
  },
  {
    ...
    sectionId: 'ALL',
    sectionName: 'All Sections',
    subjectName: 'Qudoori (Islamic Jurisprudence)',
    curriculumBookId: 'syllabus_kitab_5',
    curriculumBookName: 'Mukhtasar al-Qudoori',
    invigilatorId: 'teacher_2',
    invigilatorName: 'Qari Abdullah',
    examinerId: 'teacher_3',
    examinerName: 'Maulana Mahmudul Hasan',
    ...
    teacherName: 'Qari Abdullah',
    roomNo: 'Hall 205',
    notes: 'Check question papers before distribution',
    examDate: '2026-10-14',
    shiftId: 'shift_2',
    shiftName: 'Shift 2 (Afternoon)',
    startTime: '02:00 PM',
  ...
  },
  {
    ...
    sectionId: 'ALL',
    sectionName: 'All Sections',
    subjectName: 'Nurul Idah (Fiqh Fundamentals)',
    curriculumBookId: 'syllabus_kitab_6',
    curriculumBookName: 'Nurul Idah',
    invigilatorId: 'teacher_3',
    invigilatorName: 'Maulana Mahmudul Hasan',
    examinerId: 'teacher_1',
    examinerName: 'Hafiz Qari Zubair',
    ...
    teacherName: 'Maulana Mahmudul Hasan',
    roomNo: 'Central Hall A',
    notes: 'Final day examination session',
    examDate: '2026-10-15',
    shiftId: 'shift_1',
    shiftName: 'Shift 1 (Morning)',
    startTime: '09:00 AM',
...
export const examStore = {
  ...
  bulkUpsertExamSubjects: (tenantId = 'default', examId, examSubjectsList = []) => {
    ...
    const normalized = (Array.isArray(examSubjectsList) ? examSubjectsList : []).map((s, idx) => ({
      ...
      invigilatorId: s.invigilatorId ? String(s.invigilatorId) : (s.teacherId ? String(s.teacherId) : ''),
      invigilatorName: (s.invigilatorName || s.teacherName || '').trim(),
      examinerId: s.examinerId ? String(s.examinerId) : (s.evaluatorId ? String(s.evaluatorId) : ''),
      examinerName: (s.examinerName || s.evaluatorName || '').trim(),
      evaluatorId: s.examinerId ? String(s.examinerId) : (s.evaluatorId ? String(s.evaluatorId) : ''),
      evaluatorName: (s.examinerName || s.evaluatorName || '').trim(),
      teacherId: s.invigilatorId ? String(s.invigilatorId) : (s.teacherId ? String(s.teacherId) : ''),
      teacherName: (s.invigilatorName || s.teacherName || '').trim(),
      notes: s.notes || '',
      examDate: s.examDate || '',
      ...
      breakdownEnabled: Boolean(s.breakdownEnabled),
      components: Array.isArray(s.components) && s.components.length > 0
        ? s.components
        : [{ id: 'comp_1', name: 'Written Exam', maxMarks: Number(s.fullMarks) || 100 }],
      previousExamsEnabled: Boolean(s.previousExamsEnabled),
      previousExams: Array.isArray(s.previousExams) ? s.previousExams : [],
  ...
  addExamSubject: (tenantId = 'default', subjectData) => {
    ...
    const newSubject = {
      ...
      evaluationType: subjectData.evaluationType || 'COMPOSITE',
      roomNo: subjectData.roomNo || '',
      curriculumBookId: subjectData.curriculumBookId || null,
      curriculumBookName: subjectData.curriculumBookName || '',
      invigilatorId: subjectData.invigilatorId ? String(subjectData.invigilatorId) : (subjectData.teacherId ? String(subjectData.teacherId) : ''),
      invigilatorName: (subjectData.invigilatorName || subjectData.teacherName || '').trim(),
      examinerId: subjectData.examinerId ? String(subjectData.examinerId) : (subjectData.evaluatorId ? String(subjectData.evaluatorId) : ''),
      examinerName: (subjectData.examinerName || subjectData.evaluatorName || '').trim(),
      evaluatorId: subjectData.examinerId ? String(subjectData.examinerId) : (subjectData.evaluatorId ? String(subjectData.evaluatorId) : ''),
      evaluatorName: (subjectData.examinerName || subjectData.evaluatorName || '').trim(),
      teacherId: subjectData.invigilatorId ? String(subjectData.invigilatorId) : (subjectData.teacherId ? String(subjectData.teacherId) : ''),
      teacherName: (subjectData.invigilatorName || subjectData.teacherName || '').trim(),
      ...
      breakdownEnabled: Boolean(subjectData.breakdownEnabled),
      ...
      previousExamsEnabled: Boolean(subjectData.previousExamsEnabled),
      previousExams: Array.isArray(subjectData.previousExams) ? subjectData.previousExams : [],
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    };
