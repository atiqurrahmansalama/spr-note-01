...
import { ExamFormDrawerProps } from './types';
      ...
      <form onSubmit={form.handleSubmit} className="@container p-4 @[480px]:p-6 space-y-6 text-left">
        ...
        <div className="w-full pb-2">
          <Stepper
            ...
            onStepClick={(stepNum: number) => form.setStep(stepNum)}
            clickable={true}
        ...
        {form.step === 1 && (
          <ExamGeneralScheduleSection
            ...
            onExamDateRangeSelect={(start: string, end: string) => {
              form.setStartDate(start);
              form.setEndDate(end);
            }}
            prepStartDate={form.prepStartDate}
            prepEndDate={form.prepEndDate}
            onPrepDateRangeSelect={(start: string, end: string) => {
