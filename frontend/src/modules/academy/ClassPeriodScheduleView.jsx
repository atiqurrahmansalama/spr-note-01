...
export default function ClassPeriodScheduleView({
  ...
  return (
    <PageContainer isEmbedded={isEmbedded}>
      ...
      {!hideHeader && (
        <PageHeader
          title="Period Schedules & Routine Engine"
          subtitle="Configure dynamic class period slots, break intervals and daily routines."
          icon={TimerIcon}
          breadcrumbs={[
          ...
          actions={
            <button
              ...
              className="w-full sm:w-auto px-4 py-2.5 sm:py-2 text-xs font-bold theme-bg-accent theme-accent-text hover:opacity-95 rounded-xl shadow-md active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
