    ...
    <form onSubmit={handleSave} className="flex flex-col h-full space-y-5 p-1 text-left">
        ...
        <div className="flex items-center justify-between gap-2 pt-1 border-t theme-border">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-2.5 py-1 rounded-lg theme-bg-sub border theme-border hover:theme-bg-elevated text-xs font-bold theme-text-primary transition cursor-pointer hover:theme-accent"
              title="Minus 5 Pages"
            >
              -5
            </button>
      ...
      <div className="flex items-center justify-end gap-2.5 pt-3 border-t theme-border mt-auto">
        <button
          type="button"
          onClick={onCancel}
          className="px-4 py-2.5 rounded-xl theme-bg-sub border theme-border hover:theme-bg-elevated text-xs font-bold theme-text-secondary hover:theme-text-primary transition cursor-pointer"
        >
          Cancel
        </button>
        <button
          type="submit"
          disabled={isSaving}
          className="px-5 py-2.5 rounded-xl theme-bg-accent theme-accent-text hover:opacity-90 text-xs font-bold shadow-md transition cursor-pointer flex items-center gap-1.5 disabled:opacity-50"
        >
