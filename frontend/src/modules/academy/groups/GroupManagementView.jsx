...
export default function GroupManagementView({
  ...
  useDrawerRegistration(
    ...
    (params) => {
      ...
      return {
        title: mode === "add" ? "Create New Group" : `Edit: ${foundGroup?.name || "Group"}`,
    ...
    <PageContainer isEmbedded={isEmbedded}>
      ...
      {!hideHeader && (
        <PageHeader
          ...
          subtitle="Configure academic sub-sections, group mentors, and student allocations"
          actions={
            <>
              <button
                type="button"
      ...
      <div className="space-y-4">
        ...
        {viewMode === "grid" ? (
          <DataCardGrid
            ...
            isLoading={loading}
            loadingMessage="Loading student groups..."
            emptyIcon={GroupIcon}
