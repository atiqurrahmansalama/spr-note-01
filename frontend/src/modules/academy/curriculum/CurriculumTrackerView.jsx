...
export default function CurriculumTrackerView({
  ...
  const tableColumns = useMemo(() => [
    {
      header: 'Textbook / Syllabus',
      accessor: 'name',
      headerClassName: 'py-3 px-4',
      cellClassName: 'py-3.5 px-4 font-bold theme-text-primary',
      render: (item) => (
        <div>
    ...
    },
    {
      ...
      headerClassName: 'py-3 px-4',
      cellClassName: 'py-3.5 px-4 theme-text-secondary',
    ...
    {
      header: 'Progress',
      headerClassName: 'py-3 px-4 min-w-[160px]',
      cellClassName: 'py-3.5 px-4',
      render: (item) => {
    ...
    },
    {
      header: 'Status',
      headerClassName: 'py-3 px-4 text-center',
      cellClassName: 'py-3.5 px-4 text-center',
      render: (item) => {
        const { pct } = getProgressStats(item);
        return (
          <span
  ...
  // ─── Reusable DataCardGrid RenderCard ──────────────────────────────────────
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 sm:p-4 rounded-2xl border theme-border theme-bg-surface shadow-xs space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2.5">
          ...
          {/* Reusable CustomSelect for Semester */}
          <div>
            <CustomSelect
              label="Semester / Term"
          ...
          {/* Reusable CustomSelect for Status */}
          <div>
            <CustomSelect
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className={`p-1.5 rounded-lg border transition cursor-pointer ${
                viewMode === 'grid'
                  ? 'theme-bg-accent theme-accent-text border-transparent font-bold'
      ...
      {/* 3. Reusable Main Data View (DataTable vs. DataCardGrid) */}
      {viewMode === 'table' ? (
        <DataTable
