...
export default function LandingCreatorSpotlight() {
  return (
    <section id="creator" className="min-h-screen flex flex-col justify-center items-center py-24 px-4 theme-bg-app relative overflow-hidden select-none scroll-mt-10">
      ...
      <div className="max-w-5xl w-full mx-auto space-y-12 relative z-10">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto animate-fade-in">
          ...
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-black theme-text-primary tracking-tight">
            Generated by <span className="bg-gradient-to-r from-[var(--accent-main)] via-sky-400 to-indigo-400 bg-clip-text text-transparent">Atiqur Rahman</span>
          </h2>

          <p className="text-xs sm:text-sm theme-text-secondary leading-relaxed max-w-xl mx-auto">
            Crafted with architectural precision, high-speed responsiveness, and deep dedication to modernizing academic institutions and Quranic education worldwide.
          </p>
        </div>

        {/* Creator Showcase Card */}
        <div className="theme-bg-surface border theme-border rounded-3xl p-6 sm:p-10 shadow-2xl hover:border-[var(--accent-main)]/50 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden">
            ...
            <div className="lg:col-span-7 space-y-5 text-left">
              <div className="space-y-3">
                ...
                <p className="text-xs sm:text-sm theme-text-secondary leading-relaxed">
                  <strong>Atiqur Rahman</strong> is an accomplished full-stack software engineer and educational technology innovator focused on building resilient, high-speed, and human-centric software for Islamic academic institutions and educators.
                </p>
                <p className="text-xs sm:text-sm theme-text-secondary leading-relaxed">
