...
import { SparklesIcon, BuildingOfficeIcon, CheckCircleIcon } from "../../components/ui/Icons";

export default function LandingAudience() {
  return (
    <section id="audience" className="min-h-screen flex flex-col justify-center items-center py-24 px-4 max-w-6xl mx-auto space-y-12 select-none scroll-mt-10">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-full">
        ...
        <div className="theme-bg-surface border theme-border rounded-3xl p-6 sm:p-10 shadow-xl flex flex-col justify-between hover:border-[var(--accent-main)]/35 hover:-translate-y-1.5 transition-all duration-300 relative group">
          <div className="space-y-6">
            <div className="w-14 h-14 rounded-2xl theme-bg-accent-soft text-[var(--accent-main)] flex items-center justify-center border theme-border shrink-0 shadow-md">
              <SparklesIcon className="w-7 h-7" />
            </div>
            <div className="space-y-2">
              <h3 className="text-xl font-bold theme-text-primary">
                Individual Teachers &amp; Hifz Circles
              </h3>
            ...
            <ul className="space-y-3 text-xs theme-text-primary font-medium">
              <li className="flex items-center gap-2.5">
                <CheckCircleIcon className="w-4 h-4 text-[var(--accent-main)] shrink-0" />
