...
export default function InstitutionOnboardingDrawer({ isOpen, onClose, onSuccess }) {
  ...
  return (
    <RightDrawer
      ...
      subtitle="Set up an isolated multi-tenant academic institution hierarchy"
      icon={DepartmentIcon}
          ...
          <div className="space-y-4 animate-in fade-in duration-200">
            <div>
              ...
              <div className="flex items-center">
                <span className="px-3 py-2 rounded-l-xl theme-bg-sub border border-r-0 theme-border theme-text-secondary text-xs font-mono">
                  app.sprnote.com/
                </span>
                <input
                  type="text"
