            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 min-h-[46px] rounded-2xl theme-bg-sub border ${
                    errors.name ? 'border-rose-500' : 'theme-border'
                  } text-xs sm:text-sm font-semibold theme-text-primary focus:outline-none focus:border-[var(--accent-main)] focus:ring-2 focus:ring-[var(--accent-main)]/20 transition-all`}
                />
              </div>
              {errors.name && (
          ...
          <div className="space-y-6 animate-fade-in max-w-2xl mx-auto min-h-[480px]">
            ...
            <div>
              ...
              <div className="flex items-center">
                <span className="px-4 py-3 min-h-[46px] rounded-l-2xl theme-bg-elevated border border-r-0 theme-border theme-text-secondary text-xs sm:text-sm font-mono font-bold flex items-center">
                  app/
                </span>
                <input
                  type="text"
                  ...
                  className={`flex-1 px-4 py-3 min-h-[46px] rounded-r-2xl theme-bg-sub border ${
                    errors.slug ? 'border-rose-500' : 'theme-border'
                  } text-xs sm:text-sm font-mono font-bold text-sky-400 focus:outline-none focus:border-[var(--accent-main)] focus:ring-2 focus:ring-[var(--accent-main)]/20 transition-all`}
                />
              </div>
              {errors.slug && (
            ...
            <div className="pt-3 border-t theme-border space-y-5">
                  ...
                  {availableThanas.length > 0 ? (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 min-h-[46px] rounded-2xl theme-bg-sub border theme-border text-xs sm:text-sm font-semibold theme-text-primary focus:outline-none focus:border-[var(--accent-main)]"
                      />
                    </div>
                  )}
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-2xl theme-bg-sub border theme-border text-xs sm:text-sm font-medium theme-text-primary focus:outline-none focus:border-[var(--accent-main)] resize-none"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  } text-xs sm:text-sm font-semibold theme-text-primary focus:outline-none focus:border-[var(--accent-main)]`}
                />
                {errors.admin_name && (
