...
export default function InstitutionOnboardingForm({ onSuccess, onCancel }) {
  ...
  return (
    <div className="p-4 sm:p-5 space-y-5 h-full overflow-y-auto theme-text-primary">
      {/* Stepper Progress */}
      <div className="p-3 rounded-2xl theme-bg-sub border theme-border flex items-center justify-between text-xs">
        {[
          { num: 1, label: 'Profile' },
          { num: 2, label: 'Slug & Brand' },
          ...
          return (
            <div key={s.num} className="flex items-center gap-2">
              ...
              >
                {isCompleted ? <CheckCircleIcon className="w-3.5 h-3.5" /> : s.num}
              </div>
              <span
          ...
          <div className="space-y-3.5 animate-fade-in">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-xl theme-bg-sub border ${
                  errors.name ? 'border-rose-500' : 'theme-border'
                } text-xs theme-text-primary focus:outline-none focus:border-[var(--accent-main)]/60`}
              />
              {errors.name && (
          ...
          <div className="space-y-3.5 animate-fade-in">
            <div>
              ...
              <div className="flex items-center">
                <span className="px-2.5 py-2 rounded-l-xl theme-bg-elevated border border-r-0 theme-border theme-text-secondary text-xs font-mono">
                  app/
                </span>
                <input
                  type="text"
                  ...
                  className={`flex-1 px-3 py-2 rounded-r-xl theme-bg-sub border ${
                    errors.slug ? 'border-rose-500' : 'theme-border'
                  } text-xs font-mono text-sky-400 focus:outline-none focus:border-[var(--accent-main)]/60`}
                />
              </div>
              {errors.slug && (
          ...
          <div className="space-y-3.5 animate-fade-in">
            <div className="p-3 rounded-xl bg-sky-500/10 border border-sky-500/20 text-xs theme-text-primary flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] theme-text-secondary">
                  Full institutional administrative privileges for this tenant.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Maulana Shamsul"
                  className={`w-full px-3 py-2 rounded-xl theme-bg-sub border ${
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                {[
                  { id: 'HIFZ', title: 'Hifz Focus', icon: BookOpenIcon },
                  { id: 'GENERAL', title: 'General School', icon: AcademicCapIcon },
                  { id: 'BOTH', title: 'Dual Curriculum', icon: BuildingOfficeIcon },
                ].map((preset) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-xs theme-text-primary">{preset.title}</span>
                      </div>
        ...
        <div className="pt-4 border-t theme-border flex items-center justify-between">
          ...
          {step < 3 ? (
            <button
              type="button"
              onClick={handleNext}
              className="px-4 py-1.5 rounded-xl theme-bg-accent theme-accent-text text-xs font-bold shadow hover:opacity-90 transition cursor-pointer"
            >
              Continue
            </button>
          ) : (
            <button
              ...
              disabled={isSubmitting}
              className="px-4 py-1.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white text-xs font-bold shadow transition cursor-pointer flex items-center gap-1.5 disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
