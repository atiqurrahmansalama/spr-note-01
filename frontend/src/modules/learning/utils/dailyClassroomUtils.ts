 ...
 */
export function findMatchingPeriodSlot(pId: string | number, periodSlots: any[] = []) {
 ...
 */
export function extractPeriodOrder(item: any): number | null {
  if (!item) return null;
...
export function resolvePeriodTime(
  matchedSlot: any,
  lessonOrEval: any = null,
  fallbackOrder: any = null,
  periodSlots: any[] = []
): string {
 ...
 */
export function getDepartmentId(item: any): string {
  if (!item) return '';
 ...
 */
export function getClassId(item: any): string {
  if (!item) return '';
 ...
 */
export function getSectionId(item: any): string {
  if (!item) return '';
 ...
 */
export function getEquivalentSectionIds(targetSectionId: string | number, sections: any[] = []): Set<string> {
 ...
 */
export function getEquivalentDepartmentIds(targetDeptId: string | number, departments: any[] = []): Set<string> {
 ...
 */
export function doesLessonMatchDepartment(item: any, targetDeptId: string | number, departments: any[] = [], classes: any[] = []): boolean {
 ...
 */
export function getEquivalentClassIds(targetClassId: string | number, classes: any[] = []): Set<string> {
 ...
 */
export function doesLessonMatchClass(item: any, targetClassId: string | number, classes: any[] = []): boolean {
 ...
 */
export function doesLessonMatchSection(lesson: any, targetSectionId: string | number, sections: any[] = []): boolean {
 ...
 */
export function doesStudentMatchClass(student: any, targetClassId: string | number, classes: any[] = []): boolean {
  if (!targetClassId || targetClassId === 'ALL') return true;
 ...
 */
export function doesStudentMatchDepartment(student: any, targetDeptId: string | number, departments: any[] = [], classes: any[] = []): boolean {
  if (!targetDeptId || targetDeptId === 'ALL') return true;
  if (!student) return false;
  const targetIdStr = String(targetDeptId).trim();
 ...
 */
export function doesStudentMatchSection(student: any, targetSectionId: string | number, sections: any[] = []): boolean {
  if (!targetSectionId || targetSectionId === 'ALL' || targetSectionId === '') return true;
  if (!student) return false;
  const targetIdStr = String(targetSectionId).trim();
 ...
 */
export function isLessonInSlot(lesson: any, slotValue: string | number, periodSlots: any[] = []): boolean {
 ...
 */
export function resolveBookTeacher(book: any, teachers: any[] = [], staff: any[] = []): string {
  if (!book) return '';
 ...
 */
export function filterCurriculumBooks(curriculumBooks: any[] = [], classId: string | number, classes: any[] = [], departmentId: string | number = ''): any[] {
 ...
 */
export function getYesterdayDate(baseDate?: string): string {
  try {
 ...
 */
export function getTomorrowDate(baseDate?: string): string {
  try {
    const base = baseDate || getClassroomTodayDate();
    const d = new Date(base + 'T12:00:00');
    d.setDate(d.getDate() + 1);
