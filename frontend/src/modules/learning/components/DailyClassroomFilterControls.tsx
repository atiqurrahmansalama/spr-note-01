...
/**
 * DailyClassroomFilterControls (also LearningFilterControls)
 * Enterprise Reusable Filter Grid for Learning & Classroom modules.
 */
...
export { DailyClassroomFilterControls as LearningFilterControls };
