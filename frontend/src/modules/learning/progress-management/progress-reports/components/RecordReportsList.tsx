...
import { RecordReportsListProps, ReportItem } from "../types";
...
export default function RecordReportsList({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const newlySelected = new Set<number | string>();
  ...
  const handleContainerClick = (e: React.MouseEvent) => {
    ...
    const target = e.target as HTMLElement;
    if (target.closest(".report-card-row") || target.closest("button") || target.closest("input")) {
      return;
    }
