...
export default function LessonPlanDrawer({
  ...
  const academicData: any = useAcademicData() || {};
  const {
    departments = [],
    classes = [],
    sections = [],
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 @[480px]:grid-cols-2 gap-3">
                ...
                <CustomSelect
                  ...
                  onChange={(val: string) => {
                    form.setClassId(val);
                    const matched = classes.find((c: any) => String(c.id) === String(val));
                    if (matched) {
        ...
        <DrawerSection title="Daily Sabaq Details" icon={BookOpenIcon}>
          <div className="space-y-4">
            ...
            <CustomInput
              ...
              onChange={(val: any) => form.setLessonTitle(typeof val === "string" ? val : val?.target?.value || "")}
              required
            />
        ...
        <DrawerSection title="Homework & Instructions" icon={ChecklistIcon}>
          <div className="space-y-4">
            <CustomInput
              ...
              onChange={(val: any) => form.setHomeworkTask(typeof val === "string" ? val : val?.target?.value || "")}
            />
            <CustomInput
              type="textarea"
              rows={3}
              ...
              onChange={(val: any) => form.setLessonInstructions(typeof val === "string" ? val : val?.target?.value || "")}
            />
          </div>
        </DrawerSection>
