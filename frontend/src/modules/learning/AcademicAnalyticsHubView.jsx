...
export default function AcademicAnalyticsHubView({ defaultTab = 'LEDGER' }) {
  ...
  const metrics = useMemo(() => [
    { label: 'Evaluated Sessions', value: summaryData.totalEvaluations || 0, subValue: 'Cross-period recitation records' },
  ...
  return (
    <PageContainer>
      ...
      <div className="animate-fade-in space-y-4">
        ...
        <div className="rounded-2xl border theme-border theme-bg-surface p-6 shadow-xs space-y-6 mt-4">
          <div className="border-b theme-border pb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <h2 className="text-lg font-bold theme-text-primary mt-1">
                Class Performance & Recitation Progress Sheet
              </h2>
              <p className="text-xs theme-text-secondary">
                Institutional record of student recitation accuracy, mistakes, stucks, and evaluation scores
              </p>
            </div>
