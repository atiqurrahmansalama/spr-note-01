    ...
    <>
      ...
      <aside className="fixed lg:static top-0 right-0 z-50 w-80 h-full theme-bg-sub border-l theme-border shrink-0 flex flex-col justify-between p-5 transition-all duration-300 shadow-2xl lg:shadow-none overflow-y-auto">
        ...
        <div className="pt-4 border-t theme-border">
          <button
            onClick={onLogout}
            className="w-full theme-bg-elevated hover:bg-red-950/30 theme-text-secondary hover:text-red-400 border theme-border hover:border-red-900/40 py-2 rounded-md text-xs font-medium transition-colors cursor-pointer"
          >
            Sign Out
          </button>
        </div>
