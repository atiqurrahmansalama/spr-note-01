...
class AcademicInstitution(models.Model):
    ...
    max_institutions = models.PositiveIntegerField(default=1, help_text="Total allowed institutions under this tenant/client")
    max_branches = models.PositiveIntegerField(default=5, help_text="Total allowed branches under this institution")
    max_departments = models.PositiveIntegerField(default=10, help_text="Total allowed departments under this institution")
