...
class AcademicInstitution(models.Model):
    ...
    max_branches = models.PositiveIntegerField(default=1, help_text="Total allowed branches under this institution")
    max_departments = models.PositiveIntegerField(default=1, help_text="Total allowed departments under this institution")
