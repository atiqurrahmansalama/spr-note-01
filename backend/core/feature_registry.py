FEATURE_REGISTRY = [
    ...
    # --- ATTENDANCE & CALENDAR ECOSYSTEM (PARENT) ---
    {
        "key": "nav_attendance_management",
        "label": "Attendance & Calendar",
        "category": "ATTENDANCE",
        "description": "Student roll call, 31-day register, dynamic class slots, institutional calendar, and task manager",
        "is_parent": True,
        "parent_key": None,
        "default_enabled": True,
        "sort_order": 39,
    },
    {
        ...
        "category": "ATTENDANCE",
        "description": "Daily roll call, period & multi-session tracking, holiday softening alerts, and fast keyboard marking",
        "is_parent": False,
    ...
    },
    {
        ...
        "label": "Institutional To-Do & Tasks",
        "category": "CALENDAR",
    ...
    },
    {
        ...
        "label": "Slots & Attendance Policies",
        "category": "ATTENDANCE",
        "description": "Custom period and shift slot configuration, weekend selectors, and late arrival policies",
        "is_parent": False,
        "parent_key": "nav_attendance_management",
        "default_enabled": True,
        "sort_order": 44,
